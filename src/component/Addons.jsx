    ...
    return(
      ...
      <div>
        ...
        <nav className="nav">
         ...
         <div  className="imghbo"><img src="https://play.hbomax.com/assets/images/branding/desktop/hbomax/dt-hbomax-logo-in_app.svg" alt="" /></div>
         <div className="addon">SIGN IN</div>
